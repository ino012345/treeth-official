...
const SERVICES = [
  {
    ...
    ja: "コーポレートサイト制作",
    description:
      "WordPressを使わない独自実装で、高速・低コスト・高セキュリティを同時に実現。Coconala累計26件以上の制作実績をもとに、集客から問い合わせ獲得まで一貫してサポートします。",
  },
  {
    Icon: RocketLaunch,
    en: "Landing Page",
  ...
  },
  {
    ...
    ja: "UI/UXデザイン",
    description:
      "5年のWeb制作経験と情報処理安全確保支援士・応用情報技術者の知識を掛け合わせ、美しさとセキュリティを両立したインターフェース設計を行います。",
  },
];
