...
const FAQ_ITEMS = [
  ...
  {
    q: "今のサイトがWordPressなのですが、どのような違いがありますか？",
    a: "最大の違いは「圧倒的な表示スピード」と「セキュリティの高さ」です。本サービスでは最新のフロントエンド技術（Next.jsやAstroなど）を用いて不要なプログラムを削ぎ落としているため、ハッキングリスクを極限まで低減し、Googleの評価（SEO）にも有利な爆速サイトを実現します。リッチなアニメーションも極めて滑らかに動作します。",
  },
  {
